        ...
        <div class="card-body">
            ...
            <div class="row">
                <button class="btn btn-sm btn-primary" style="border-radius: 30px;" data-bs-toggle="modal"
                    data-bs-target="#ModalTambahUser"><i class="bi bi-file-earmark-plus-fill"></i>User</button>
            </div>
            </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-floating mb-3">
                                            <select class="form-select" aria-label="Default select example" name="level"
                                                ...
                                                <option hidden value="3">Member</option>
                                                <option hidden value="4">Tamu</option>
                                            </select>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-floating mb-3">
                                                <select disabled class="form-select" aria-label="Default select example"
                                                    ...
                                                    <?php
                                                    $data = array("Owner/Admin", "operator", "Member");
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_edit_user.php"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-floating mb-3">
                                                <input <?php echo ($row['username'] == $_SESSION['username_travelgo']) ? 'disabled' : ''; ?> type="email" class="form-control"
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-floating mb-3">
                                                <select class="form-select" aria-label="Default select example" require
                                                    name="level" id="">
                                                    <?php
                                                    $data = array("Owner/Admin", "Operator");
                                                    foreach ($data as $key => $value) {
                                                        if ($row['level'] == $key + 1) {
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_delete_user.php"
                                    ...
                                    <div class="col-lg-12">
                                        <?php
                                        if ($row['username'] == $_SESSION['username_travelgo']) {
                                ...
                                <form class="needs-validation" novalidate action="proses/proses_reset_password.php"
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-success" name="input_user_validate"
                                            value="12345" <?php echo ($row['username'] == $_SESSION['username_travelgo']) ? 'disabled' : ''; ?>>Reset Password</button>
                                    </div>
                                </form>
                            </div>
                        </div>
