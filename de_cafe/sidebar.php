                ...
                <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar"
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav nav-pills flex-column justify-content-end flex-grow-1">
                            ...
                            <li class="nav-item">
                                <a class="nav-link ps-2 <?php echo (isset($_GET['x']) && $_GET['x'] == 'menu') ? 'active link-light' : 'link-dark'; ?>" href="menu"><i class="bi bi-cart"></i> Daftar Menu</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link ps-2 <?php echo (isset($_GET['x']) && $_GET['x'] == 'costumer') ? 'active link-light' : 'link-dark'; ?>" href="costumer"><i class="bi bi-person"></i> Customer</a>
                            </li>
                            <?php if($hasil['level']==1){?>
                            <li class="nav-item">
                                <a class="nav-link ps-2 <?php echo (isset($_GET['x']) && $_GET['x'] == 'user') ? 'active link-light' : 'link-dark'; ?>" href="user"><i class="bi bi-bag-dash"></i> User</a>
                            </li>
                            <li class="nav-item">
